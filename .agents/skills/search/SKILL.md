...
- `/search #decision`
- `/search #blocker`
- `/search #project/netilion-monorepo`
...
- **Goals/** — career vision, yearly, monthly
- **Projects/** — per-project CLAUDE.md and weekly reviews (Decisions & Learnings live here)
- **Templates/** — active templates (`Daily Note - Career`, `Weekly Project Review`)
- **Archives/** — archived content (including old templates)
...
### Daily Notes/
- **2026-07-15.md** (line 23): ...matching context...
- **2026-07-14.md** (line 8): ...matching context...

### Projects/
- **netilion2/CLAUDE.md** (line 45): ...matching context...

### Goals/
- **2. Monthly Goals (Current).md** (line 12): ...matching context...

**Found X matches across Y files**
```

### Useful career-vault searches

- `#project/netilion2` — all activity tagged to the primary project
- `#decision` — decisions logged in daily notes (also cross-check `Projects/*/CLAUDE.md` Decisions & Learnings tables)
- `#blocker` — every blocker mention across daily notes
